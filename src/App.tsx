...
export const App = () => {
    ...
    const deleteTask = (todolistId: string, taskId: string) => {
        ...
        dispatchToTasks(RemoveTaskAC({todolistId: todolistId, taskId: taskId}))   // можно сокращенно {todolistId, title}
    }

    const createTask = (todolistId: string, title: string) => {
        // const newTask = {id: v1(), title, isDone: false}
        // setTasks({...tasks, [todolistId]: [newTask, ...tasks[todolistId]]})
        dispatchToTasks(AddTaskAC({todolistId, title})) //сокращенно от {todolistId: todolistId, taskId: taskId}
    }
